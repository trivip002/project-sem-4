                            ...
                            <div class="la5lo1">
                                <div class="owl-carousel featured_courses owl-theme">
                                    <div class="item">
                                        <div class="fcrse_1 mb-20">
                                            <a href="course_detail_view.html" class="fcrse_img">
                                                <img src="<c:url value='/static/assets/images/courses/img-1.jpg' />" alt="">
                                    ...
                                    <div class="item">
                                        <div class="fcrse_1 mb-20">
                                            <a href="course_detail_view.html" class="fcrse_img">
                                                <img src="<c:url value='/static/assets/images/courses/img-2.jpg' />" alt="">
                                                <div class="course-overlay">
                                                    <div class="badge_seller">Bestseller</div>
                                                    <div class="crse_reviews">
                                                        <i class='uil uil-star'></i>4.5
                                    ...
                                    <div class="item">
                                        <div class="fcrse_1 mb-20">
                                            <a href="course_detail_view.html" class="fcrse_img">
                                                <img src="<c:url value='/static/assets/images/courses/img-3.jpg' />"  alt="">
                                                <div class="course-overlay">
                                                    <div class="badge_seller">Bestseller</div>
                                                    <div class="crse_reviews">
                                                        <i class='uil uil-star'></i>4.5
                                    ...
                                    <div class="item">
                                        <div class="fcrse_1 mb-20">
                                            <a href="course_detail_view.html" class="fcrse_img">
                                                <img src="<c:url value='/static/assets/images/courses/img-4.jpg' />" alt="">
                                                <div class="course-overlay">
                                                    <div class="badge_seller">Bestseller</div>
                                                    <div class="crse_reviews">
                                    ...
                                    <div class="item">
                                        <div class="fcrse_1 mb-20">
                                            <a href="course_detail_view.html" class="fcrse_img">
                                                <img src="<c:url value='/static/assets/images/courses/img-5.jpg' />" alt="">
                                                <div class="course-overlay">
                                                    <div class="badge_seller">Bestseller</div>
                                                    <div class="crse_reviews">
                                                        <i class='uil uil-star'></i>4.5
                                    ...
                                    <div class="item">
                                        <div class="fcrse_1 mb-20">
                                            <a href="course_detail_view.html" class="fcrse_img">
                                                <img src="<c:url value='/static/assets/images/courses/img-6.jpg' />" alt="">
                                                <div class="course-overlay">
                                                    <div class="badge_seller">Bestseller</div>
                                                    <div class="crse_reviews">
                                                        <i class='uil uil-star'></i>5.0
                                    ...
                                    <div class="item">
                                        <div class="fcrse_1 mb-20">
                                            <a href="course_detail_view.html" class="fcrse_img">
                                                <img src="<c:url value='/static/assets/images/courses/img-7.jpg' />" alt="">
                                                <div class="course-overlay">
                                                    <div class="badge_seller">Bestseller</div>
                                                    <div class="crse_reviews">
                                                        <i class='uil uil-star'></i>5.0
                            ...
                            <div class="la5lo1">
                                <div class="owl-carousel featured_courses owl-theme">
                                    <div class="item">
                                        <div class="fcrse_1 mb-20">
                                            <a href="course_detail_view.html" class="fcrse_img">
                                                <img src="<c:url value='/static/assets/images/courses/img-14.jpg' />" alt="">
                                                <div class="course-overlay">
                                                    <span class="play_btn1"><i class="uil uil-play"></i></span>
                                                    <div class="crse_timer">
                                                        12 hours
                                    ...
                                    <div class="item">
                                        <div class="fcrse_1 mb-20">
                                            <a href="course_detail_view.html" class="fcrse_img">
                                                <img src="<c:url value='/static/assets/images/courses/img-11.jpg' />" alt="">
                                                <div class="course-overlay">
                                                    <span class="play_btn1"><i class="uil uil-play"></i></span>
                                                    <div class="crse_timer">
                                                        28 hours
                                    ...
                                    <div class="item">
                                        <div class="fcrse_1 mb-20">
                                            <a href="course_detail_view.html" class="fcrse_img">
                                                <img src="<c:url value='/static/assets/images/courses/img-18.jpg' />" alt="">
                                                <div class="course-overlay">
                                                    <span class="play_btn1"><i class="uil uil-play"></i></span>
                                                    <div class="crse_timer">
                                                        15 hours
                                    ...
                                    <div class="item">
                                        <div class="fcrse_1 mb-20">
                                            <a href="course_detail_view.html" class="fcrse_img">
                                                <img src="<c:url value='/static/assets/images/courses/img-19.jpg' />" alt="">
                                                <div class="course-overlay">
                                                    <div class="crse_reviews">
                                                        <i class='uil uil-star'></i>5.0
                                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="fcrse_1 mb-20">
                                            <a href="#" class="fcrse_img">
                                                <img src="<c:url value='/static/assets/images/courses/img-12.jpg' />" alt="">
                                                <div class="course-overlay">
                                                    <div class="crse_reviews">
                                    ...
                                    <div class="item">
                                        <div class="fcrse_1 mb-20">
                                            <a href="#" class="fcrse_img">
                                                <img src="<c:url value='/static/assets/images/courses/img-13.jpg' />" alt="">
                                                <div class="course-overlay">
                                                    <span class="play_btn1"><i class="uil uil-play"></i></span>
                                                    <div class="crse_timer">
                                                        30 hours
                                    ...
                                    <div class="item">
                                        <div class="fcrse_1 mb-20">
                                            <a href="#" class="fcrse_img">
                                                <img src="<c:url value='/static/assets/images/courses/img-20.jpg' />" alt="">
                                                <div class="course-overlay">
                                                    <div class="crse_reviews">
                                                        <i class='uil uil-star'></i>5.0
                                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="fcrse_1 mb-20">
                                            <a href="course_detail_view.html" class="fcrse_img">
                                                <img src="<c:url value='/static/assets/images/courses/img-16.jpg' />" alt="">
                                                <div class="course-overlay">
                                                    <span class="play_btn1"><i class="uil uil-play"></i></span>
                                                    <div class="crse_timer">
                                                        22 hours
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="right_side">
                            <div class="fcrse_2 mb-30">
                                <div class="tutor_img">
                                    <a href="my_instructor_profile_view.html"><img src="<c:url value='/static/assets/images/left-imgs/img-2.jpg' />" alt=""></a>
                                </div>
                                <div class="tutor_content_dt">
                                    <div class="tutor150">
