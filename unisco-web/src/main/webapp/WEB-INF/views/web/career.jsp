                        ...
                        <div class="course_tabs">
                            <nav>
                                <div class="nav nav-tabs tab_crse  justify-content-center">
                                    ...
                                    <a class="nav-item nav-link" href="<c:url value="/blog"/>">Blog</a>
                                    <a class="nav-item nav-link" href="<c:url value="/company"/>">Company</a>
                                    <a class="nav-item nav-link active" href="<c:url value="/career"/>">Careers</a>
                                </div>
                            </nav>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="title484">
                            ...
                            <img class="line-title" src="<c:url value="/static/assets/images/line.svg"/>" alt="">
                                ...
                                <div class="la5lo1">
                                    <div class="owl-carousel feature_careers owl-theme">
                                        <div class="item">
                                            <div class="career_item">
                                                <div class="career_item_img">
                                                    <img src="<c:url value="/static/assets/images/about/career-1.jpg"/>" alt="">
                                                </div>
                                        ...
                                        <div class="item">
                                            <div class="career_item">
                                                <div class="career_item_img">
                                                    <img src="<c:url value="/static/assets/images/about/career-2.jpg"/>" alt="">
                                                </div>
                                        ...
                                        <div class="item">
                                            <div class="career_item">
                                                <div class="career_item_img">
                                                    <img src="<c:url value="/static/assets/images/about/career-3.jpg"/>" alt="">
                                                </div>
                                                <h4>We are global</h4>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam eget enim in turpis consequat tempor sed id neque. Nam at felis et elit auctor accumsan. Nunc at tortor tellus. Cras dignissim velit velit, ac sollicitudin mi bibendum in. In vel nibh sodales, venenatis eros a, vulputate ligula.</p>
                                            </div>
                                        ...
                                        <div class="item">
                                            <div class="career_item">
                                                <div class="career_item_img">
                                                    <img src="<c:url value="/static/assets/images/about/career-4.jpg"/>" alt="">
                                                </div>
