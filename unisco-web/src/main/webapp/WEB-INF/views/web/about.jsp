                        ...
                        <div class="course_tabs">
                            <nav>
                                <div class="nav nav-tabs tab_crse  justify-content-center">
                                    <a class="nav-item nav-link active" href="<c:url value="/about"/>">About</a>
        ...
        <div class="_215zd5">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="story125">
                            <img src="<c:url value="/static/assets/images/about/stroy_img.png"/>" alt="">
                        </div>
                    </div>
        ...
        <div class="_215xd5">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="jmio125">
                            <img src="<c:url value="/static/assets/images/about/team.jpg"/>" alt="">
                        </div>
                    </div>
                </div>
            </div>
