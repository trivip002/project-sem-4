                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6">
                                                            <div class="ui search focus mt-30 lbel25">
                                                                ...
                                                                <div class="ui left icon input swdh19">
                                                                    <input type="text" class="prompt srch_explore" maxlength="60" onfocus="true">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 col-md-6">
                                                            <div class="ui search focus mt-30 lbel25">
                                                                ...
                                                                <div class="ui left icon input swdh19">
                                                                    <input type="text" class="prompt srch_explore" maxlength="60">
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="course_des_bg">
                                                                    <div class="textarea_dt">
                                                                        <div class="ui form swdh339">
                                                                            <div class="field">
                                                                                <textarea rows="5" placeholder="Insert your course description"/>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-4 col-md-12">
                                                            ...
                                                            <select class="ui hj145 dropdown cntry152 prompt srch_explore">
                                                                ...
                                                                <c:forEach items="${listLang}" var="lL">
                                                                    <option value="${lL.key}" label="${lL.value}" ${courseEdit.courseLanguage.equals(lL.value)?"selected='true'":""}/>
                                                                </c:forEach>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="view_all_dt">
                                                                <div class="view_img_left">
                                                                    <div class="view__img">
                                                                        <img src="${courseEdit.courseImg}" alt="">
                                                                    </div>
                                                                </div>
                                                                        ...
                                                                        <table class="table ucp-table">
                                                                            ...
                                                                            <c:forEach items="${listSectionEdit}" var="s">
                                                                                <c:if test="${s.course.courseId.equals(courseEdit.courseId)}">
                                                                                    <tr>
                                                                                        <td class="text-center">${s.sectionId}</td>
                                                                                        <td class="cell-ta">${s.sectionTitle}</td>
                                                                                    ...
                                                                                    <c:forEach items="${listVideoEdit}" var="v">
                                                                                        <c:if test="${v.section.sectionId.equals(s.sectionId)}">
                                                                                            <tr>
                                                                                                ...
                                                                                                <td class="cell-ta">${v.videoName}</td>
                                                                                                <td class="text-center"><a href="#" id="btnPreview" data-toggle="modal" data-target="#previewModal_${v.videoId}">${v.videoName}</a></td>
                                                                                                    ...
                                                                                                    <div class="modal-dialog">
                                                                                                        <div class="modal-content">
                                                                                                            ...
                                                                                                            <c:if test="${!(v.videoUrl.contains('iframe'))}">
                                                                                                                <div class="modal-body">
                                                                                                                        ${v.videoUrl}
                                                                                                                    <iframe src="https://drive.google.com/file/d/1csEixSdB1Mr_V8gj-ykD5tkG-tYrqqLl/preview"
